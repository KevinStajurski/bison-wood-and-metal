...
//     title: 'Nosotros',
//     description: 'Bison Wood & Metal - Nosotros',
//     keywords: 'Bison, construcción, integral, constructora, carpintería, herrería, decoración, interiorismo, nosotros',
// }
    ...
    return (
        <div id='nosotros' className={styles.Nosotros}>
            ...
            <div className={styles.NosotrosDivUno}>
                <h2>Nosotros</h2>
                <p>Somos <strong>Bison Wood & Metal</strong>, una empresa constructora ubicada en Córdoba. Nuestra misión es <br />proporcionar soluciones integrales en el campo de la construcción.</p>
            </div>
            ...
            <div className={styles.NosotrosDivDos}>
                ...
                <div className={styles.NosotrosDivDosA}>
                    <h3>Qué hacemos</h3>
                    <p>Ejecutamos <strong>proyectos de construcción</strong> llave en <br /> mano para empresas constructoras y desarrollistas,<br /> integrando nuestros servicios con <strong>compromiso<br /> transparencia</strong> y <strong>capacidad de gestión.</strong></p>
                </div>
            </div>
